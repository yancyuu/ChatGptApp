...
from .identity.auth_token_service import _auth_token
from .organization.customer_service import _customer
from .api.openai_service import _openai
...
def init_blueprint(app):
    blueprints = [_auth_token, _customer, _openai]
